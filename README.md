...
Для чего это может быть нужно. Представьте себе чат, мы выводим одну из комнат чата. Туда постоянно входят новые люди, что-то там пишут. В сообщениях чата мы храним только id юзера, а остальная информация хранится в коллекции users. Всех юзеров грузить на клиента смысла нет, нужны только те, сообщения которых есть в нашей комнате.
